...
<div  data-backdrop="static" class="modal fade" id="addreviews" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="exampleModalLabel" style="color:#000000">Reviews</h4>
            </div>
            <form id="frm_reviews" accept-charset="UTF-8"  method="post">
                <div class="modal-body">
                    <div id="reg_error"></div>
                    <div class="form-group">

                        <input  name="username" type="text" value="1<?php echo $user->is_logged_in()?$user->user_fullname:'james'; ?>" class="form-control" placeholder="Name">
                    </div>


                    <div class="form-group">
                        <textarea name="reviewtext"  class="form-control" placeholder="Write your review here"></textarea>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 page-scroll">
                    <a href="#page-top"><strong><span class="foot-nom">Leloo&nbsp;</span></strong></a>Copyright &copy;
