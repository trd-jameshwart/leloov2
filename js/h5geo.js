...
function display_sorted_results(localstorage_data){
    ...
    for(var i = 0 ; i < data.length ; i++){
        ...
        str_container += "<div class='col-lg-6 '> <button class='btn-primary add_review' data-toggle='modal' data-target='#addreview' data-place_id= '"+placedata.place_id+"'> Add reviews</button></button>"+place_name+place_address+place_img_representation+place_internationa_phonenuber+place_rating+place_website + final_users_review +"</div>";
    }
